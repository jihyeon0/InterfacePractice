...
#include "ReflectionPractice/Public/ItemInterface.h"
...
REFLECTIONPRACTICE_API UClass* Z_Construct_UClass_UItemInterface();
REFLECTIONPRACTICE_API UClass* Z_Construct_UClass_UItemInterface_NoRegister();
UPackage* Z_Construct_UPackage__Script_ReflectionPractice();
// End Cross Module References

// Begin Interface UItemInterface Function ActivateItem
struct Z_Construct_UFunction_UItemInterface_ActivateItem_Statics
{
	struct ItemInterface_eventActivateItem_Parms
	{
		AActor* Activator;
	};
#if WITH_METADATA
...
#endif // WITH_METADATA
	static const UECodeGen_Private::FObjectPropertyParams NewProp_Activator;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UItemInterface_ActivateItem_Statics::NewProp_Activator = { "Activator", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ItemInterface_eventActivateItem_Parms, Activator), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UItemInterface_ActivateItem_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UItemInterface_ActivateItem_Statics::NewProp_Activator,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UItemInterface_ActivateItem_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UItemInterface_ActivateItem_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UItemInterface, nullptr, "ActivateItem", nullptr, nullptr, Z_Construct_UFunction_UItemInterface_ActivateItem_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UItemInterface_ActivateItem_Statics::PropPointers), sizeof(Z_Construct_UFunction_UItemInterface_ActivateItem_Statics::ItemInterface_eventActivateItem_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UItemInterface_ActivateItem_Statics::Function_MetaDataParams), Z_Construct_UFunction_UItemInterface_ActivateItem_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UItemInterface_ActivateItem_Statics::ItemInterface_eventActivateItem_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UItemInterface_ActivateItem()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UItemInterface_ActivateItem_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(IItemInterface::execActivateItem)
{
	P_GET_OBJECT(AActor,Z_Param_Activator);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->ActivateItem(Z_Param_Activator);
	P_NATIVE_END;
}
// End Interface UItemInterface Function ActivateItem

// Begin Interface UItemInterface Function GetItemType
struct Z_Construct_UFunction_UItemInterface_GetItemType_Statics
{
	struct ItemInterface_eventGetItemType_Parms
	{
		FName ReturnValue;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UItemInterface_GetItemType_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ItemInterface_eventGetItemType_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UItemInterface_GetItemType_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UItemInterface_GetItemType_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UItemInterface_GetItemType_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UItemInterface_GetItemType_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UItemInterface, nullptr, "GetItemType", nullptr, nullptr, Z_Construct_UFunction_UItemInterface_GetItemType_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UItemInterface_GetItemType_Statics::PropPointers), sizeof(Z_Construct_UFunction_UItemInterface_GetItemType_Statics::ItemInterface_eventGetItemType_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x40020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UItemInterface_GetItemType_Statics::Function_MetaDataParams), Z_Construct_UFunction_UItemInterface_GetItemType_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UItemInterface_GetItemType_Statics::ItemInterface_eventGetItemType_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UItemInterface_GetItemType()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UItemInterface_GetItemType_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(IItemInterface::execGetItemType)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(FName*)Z_Param__Result=P_THIS->GetItemType();
	P_NATIVE_END;
}
// End Interface UItemInterface Function GetItemType
...
void UItemInterface::StaticRegisterNativesUItemInterface()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "ActivateItem", &IItemInterface::execActivateItem },
		{ "GetItemType", &IItemInterface::execGetItemType },
...
struct Z_Construct_UClass_UItemInterface_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UItemInterface_ActivateItem, "ActivateItem" }, // 2783718155
		{ &Z_Construct_UFunction_UItemInterface_GetItemType, "GetItemType" }, // 1596222254
...
template<> REFLECTIONPRACTICE_API UClass* StaticClass<UItemInterface>()
{
	return UItemInterface::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_git_InterfacePractice_ReflectionPractice_Source_ReflectionPractice_Public_ItemInterface_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UItemInterface, UItemInterface::StaticClass, TEXT("UItemInterface"), &Z_Registration_Info_UClass_UItemInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UItemInterface), 3877650075U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_git_InterfacePractice_ReflectionPractice_Source_ReflectionPractice_Public_ItemInterface_h_2881130342(TEXT("/Script/ReflectionPractice"),
	Z_CompiledInDeferFile_FID_git_InterfacePractice_ReflectionPractice_Source_ReflectionPractice_Public_ItemInterface_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_git_InterfacePractice_ReflectionPractice_Source_ReflectionPractice_Public_ItemInterface_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
